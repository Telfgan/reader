...
SECRET_KEY = 'django-insecure-rluksczm28)78%3ds%&v2r9ktn*$+)%redx#y-7ok(0(ste^dr'
...
INSTALLED_APPS = [
    ...
    'DjangoReader.apps.DjangoreaderConfig',
    'djangoProject2',
]
...
#STATICFILES_DIRS = (
   ...
   # '/path/to/djangoProject2/DjangoReader/static/',
#)
